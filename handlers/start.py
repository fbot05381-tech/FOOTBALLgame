...
print("✅ [start.py] /start_football handler loaded")  # Debug print (optional)

@Client.on_message(filters.command("start_football") & filters.group)
async def start_football(client, message: Message):
    print(f"📥 [start.py] /start_football received from chat {message.chat.id}")  # Debug print (optional)
